...
function Hero() {
  return (
    <div className="hero min-h-120 relative overflow-hidden">
      ...
      <div
        className="hero-content flex flex-col md:items-start items-start text-left justify-start w-full px-6 md:px-12 pt-24 md:pt-32 text-neutral-content"
        data-aos="fade-right"
      >
