    ...
    <>
      <div className="p-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-2">
          <div className="grid grid-cols-2 md:grid-cols-2 gap-2 overflow-hidden">
            <div>
              <Image
                src={Trainer3}
                width={400}
          ...
          <div className="text-pretty m-4 p-2">
            <p className="text-pretty ">
              ...
              <div className="text-center mt-4">
                <Link href="/join">
                <button className="btn btn-outline items-center ">Explore more</button>
                </Link>
