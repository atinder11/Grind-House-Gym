  ...
  return (
    <div className="px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
        {/* Monthly */}
        <div className="card bg-base-200 shadow-sm w-full max-w-sm h-full flex flex-col justify-between">
          <div className="card-body flex flex-col flex-grow">
            ...
            <Link href="/join">
            <button className="btn btn-neutral btn-block mt-6" >Subscribe</button>
            </Link>
        ...
        {/* Quarterly */}
        <div className="card bg-black text-white shadow-sm w-full max-w-sm h-full flex flex-col justify-between">
          <div className="card-body flex flex-col flex-grow">
            ...
            <Link href="/join">
            <button className="btn btn-outline btn-block mt-6">Subscribe</button>
            </Link>
